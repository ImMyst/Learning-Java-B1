...
private int PrixTotalCommande()
{
 ...
 public void AfficherArticles()
 {
	...
	System.out.println("Numéro facture:"+this.IdFacture);
	...
	while(i < this.articles.size())
	{
		System.out.println("Référence article:"+this.articles.get(i).getRef());
		...
		{
		System.out.println("Référence article:"+this.lots.get(i).getRef());
